...
export class StreamFunded extends ethereum.Event {
...
export class Contract extends ethereum.SmartContract {
  ...
  _xdex(): Address {
    let result = super.call("_xdex", "_xdex():(address)", []);

    return result[0].toAddress();
  }

  try__xdex(): ethereum.CallResult<Address> {
    let result = super.tryCall("_xdex", "_xdex():(address)", []);
    if (result.reverted) {
  ...
  streams(param0: BigInt): Contract__streamsResult {
    let result = super.call(
      "streams",
      "streams(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,address,address,bool)",
  ...
  try_streams(param0: BigInt): ethereum.CallResult<Contract__streamsResult> {
  ...
  createStream(
    ...
    let result = super.call(
      "createStream",
      "createStream(address,uint256,uint256,uint256,uint256):(uint256)",
      [
        ethereum.Value.fromAddress(recipient),
        ethereum.Value.fromUnsignedBigInt(depositAmount),
        ethereum.Value.fromUnsignedBigInt(startBlock),
        ethereum.Value.fromUnsignedBigInt(kBlock),
        ethereum.Value.fromUnsignedBigInt(unlockRatio)
      ]
    );
  ...
  isStream(streamId: BigInt): boolean {
    let result = super.call("isStream", "isStream(uint256):(bool)", [
  ...
  try_isStream(streamId: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("isStream", "isStream(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(streamId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getStream(streamId: BigInt): Contract__getStreamResult {
    let result = super.call(
      "getStream",
      "getStream(uint256):(address,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(streamId)]
    );
  ...
  try_getStream(
    streamId: BigInt
  ): ethereum.CallResult<Contract__getStreamResult> {
    let result = super.tryCall(
      "getStream",
      "getStream(uint256):(address,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(streamId)]
  ...
  fundStream(streamId: BigInt, amount: BigInt): boolean {
    let result = super.call(
      "fundStream",
      "fundStream(uint256,uint256):(bool)",
      [
        ethereum.Value.fromUnsignedBigInt(streamId),
  ...
  try_balanceOf(
    streamId: BigInt
  ): ethereum.CallResult<Contract__balanceOfResult> {
    let result = super.tryCall(
      "balanceOf",
      "balanceOf(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(streamId)]
  ...
  getVersion(): Bytes {
    let result = super.call("getVersion", "getVersion():(bytes32)", []);

    return result[0].toBytes();
  }

  try_getVersion(): ethereum.CallResult<Bytes> {
    let result = super.tryCall("getVersion", "getVersion():(bytes32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class FundStreamCall extends ethereum.Call {
